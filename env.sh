...
export PLUGIN_SOURCE_DIR="${PLUGIN_SOURCE_DIR:=$PLUGIN_DIR/src}"
export PLUGIN_TEST_DIR="${PLUGIN_TEST_DIR:=$PLUGIN_DIR/test}"
export PLUGIN_LIBS_DIR="${PLUGIN_LIBS_DIR:=$PLUGIN_DIR/libs}"
export PLUGIN_BUILD_DIR="${PLUGIN_BUILD_DIR:=$PLUGIN_DIR/build}"
